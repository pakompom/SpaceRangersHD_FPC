...
begin
  ...
  Disqualified :=
      Galaxy.EditableStateApplied or Galaxy.CustomRules.Enabled or (Galaxy.GetCheatPoints <> 0);
  ...
  if VictoryAchieved and not Galaxy.EditableStateApplied and (Galaxy.GetCheatPoints = 0) then
  begin
